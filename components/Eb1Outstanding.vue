<template>
  <v-card :color="enabled">
    <v-card-title class="justify-center"> EB1: Kimagasló Professzor/kutató</v-card-title>
    <v-card-text>
...
<script lang="ts">
  ...
  get enabled() {
  return (this.userDetails.professor || this.userDetails.extraordinaryAbility) ? 'colorActive' : 'colorInactive'
  }
  }
</script>
